...
🚨 CRITICAL: ALWAYS use wildcards for project names AND token symbols:
- Projects: project ILIKE '%aerodrome%' NOT project ILIKE 'aerodrome'  
- Tokens: symbol ILIKE '%eth%' NOT symbol ILIKE 'eth' (finds ETH, WETH, WSTETH, ETH+, etc.)
- This ensures users get comprehensive results without knowing exact naming conventions
