...
For "best pools" or "best lending" queries, use EXACTLY this structure:
...
💡 TIP FOR BETTER DIVERSITY: The query returns ~100 rows which may include same pool at different timestamps.
The answer generator will identify unique pools and show variety across chains/protocols.
This ensures comprehensive cross-chain analysis!
...
For "best pools" or "best opportunities" queries, COPY THIS STRUCTURE:
...
✅ WHERE clause starts with: ts >= (SELECT MAX(ts) - 21600 FROM update.cl_pool_hist)
